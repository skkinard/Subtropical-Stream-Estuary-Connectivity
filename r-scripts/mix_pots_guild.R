...
my_table <- filter(my_table, GUILD %in% c('Fish', 'Invertebrate'))
...
mix_site_guild <- left_join(my_table, df%>%select(SITE, BAYDIST_KM:ELEV_SITE_M)%>%unique())
...
# Plots
( guild_PPTAVG_SITE <- plotter(mix_site_guild, PPTAVG_SITE) +
    xlab('Rainfall (cm/yr)') )

( guild_BAYDIST_KM <- plotter(mix_site_guild, BAYDIST_KM) +
    xlab('Estuary Distance (km)') )

( guild_ELEV_SITE_M <- plotter(mix_site_guild, ELEV_SITE_M) +
    xlab('Elevation (m)') )

( guild_HIRES_LENTIC_DENS <- plotter(mix_site_guild, HIRES_LENTIC_DENS) +
    xlab('Lentic Density') )

( guild_NPDES_MAJ_DENS <- plotter(mix_site_guild, NPDES_MAJ_DENS) +
    xlab('Wastewater Density') )

( guild_RAW_DIS_NEAREST_MAJ_NPDES <- plotter(mix_site_guild, RAW_DIS_NEAREST_MAJ_NPDES) +
    xlab('Wastewater Distance') )

( guild_RAW_DIS_NEAREST_DAM <- plotter(mix_site_guild, RAW_DIS_NEAREST_DAM) +
    xlab('Dam Distance') )
...
# Export plots
ggsave('Figures/guild_PPTAVG_SITE.png',
       guild_PPTAVG_SITE,
       'png')
ggsave('Figures/guild_BAYDIST_KM.png',
       guild_BAYDIST_KM,
       'png')
ggsave('Figures/guild_ELEV_SITE_M.png',
       guild_ELEV_SITE_M,
       'png')
ggsave('Figures/guild_HIRES_LENTIC_DENS.png',
       guild_HIRES_LENTIC_DENS,
       'png')
ggsave('Figures/guild_NPDES_MAJ_DENS.png',
       guild_NPDES_MAJ_DENS,
       'png')
ggsave('Figures/guild_RAW_DIS_NEAREST_MAJ_NPDES.png',
       guild_RAW_DIS_NEAREST_MAJ_NPDES,
       'png')
ggsave('Figures/guild_RAW_DIS_NEAREST_DAM.png',
       guild_RAW_DIS_NEAREST_DAM,
       'png')
